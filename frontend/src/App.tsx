                ...
                <div className="results-container">
                  ...
                  <Card className="result-card">
                    <div className="card-header">
                      ...
                      <Space size={8} wrap>
                        <Button type="link" size="small" onClick={() => setShowSignalsInfo((prev) => !prev)}>
                          {showSignalsInfo ? "Hide Describe" : "Describe"}
                        </Button>
                        <Button size="small" onClick={() => setShowPriceLine((prev) => !prev)}>
                          {showPriceLine ? "Hide Price" : "Show Price"}
                        </Button>
                        <Button size="small" onClick={() => setShowBuySignals((prev) => !prev)}>
                          {showBuySignals ? "Hide Buys" : "Show Buys"}
                        </Button>
                        <Button size="small" onClick={() => setShowSellSignals((prev) => !prev)}>
                          {showSellSignals ? "Hide Sells" : "Show Sells"}
                        </Button>
                    ...
                    {showSignalsInfo && (
                      <Paragraph type="secondary" style={{ marginBottom: 12 }}>
                        The blue line tracks the average instrument price. Green triangles mark buy entries generated by the
                        indicator mix, while red diamonds represent the corresponding exits after hold-days or stop / take-profit thresholds.
                      </Paragraph>
                    )}
                    <SignalChart
